          ...
          <div className="title-style-two text-center mb-150 md-mb-70">
            <div className="row">
              <div className="col-xl-8 col-lg-9 col-md-10 m-auto">
                <p>GET IN TOUCH</p>
                <h2>
                  Choose REDCRIX your next IT Service Provider
                  <span>
                    for your business.
                    <img src="images/shape/line-shape-2.svg" alt="shape" />
                  </span>
              ...
              >
                <div className="text-details pt-35 md-pb-50">
                  ...
                  <h3 className="title font-gilroy-bold">
                    Meet Our Working Agents.
                  </h3>
                  <p className="text-meta">
                    Our team is your team. When your mission is to be better,
                    faster and smarter, you need the best professionals driving
                    your vision forward. You need professionals who can create
                    focused strategies that align with business goals, who can
                    infuse their creativity into groundbreaking features. Who
                    can work with you efficiently, and delivers above the
                    expectations. If you’d like to get in touch with us you can
                    email us at hello@redcrix.com.
                  </p>
                  <div className="quote-wrapper">
                    ...
                    <div className="name">
                      <strong>Courtney Robinson</strong> CFO <br />
                      hypi.i
                    </div>
                  </div>
                  {/* /.quote-wrapper */}
            ...
            <div className="row">
              ...
              >
                <div className="text-details pt-35 md-pb-50">
                  ...
                  <p className="text-meta">
                    stand with friendly interface with lots of features that
                    help our team and csutomer to collbarate easily.
                  </p>
                  <div className="quote-wrapper">
                    <div
                      className="
